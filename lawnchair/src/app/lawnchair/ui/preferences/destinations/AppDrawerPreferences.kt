...
fun AppDrawerPreferences(
    ...
    PreferenceLayout(
        ...
        val drawerModeAdapter = prefs.drawerMode.getAdapter()
        Column {
            ListPreference(
                label = stringResource(id = R.string.layout),
                adapter = drawerModeAdapter,
                entries = listOf(
                    ListPreferenceEntry(
                        value = PreferenceManager.DRAWER_MODE_CARDS,
                        label = { stringResource(id = R.string.drawer_mode_category_cards) },
                    ),
                    ListPreferenceEntry(
                        value = PreferenceManager.DRAWER_MODE_ALPHABETICAL,
                        label = { stringResource(id = R.string.feed_default) },
                    ),
                    ListPreferenceEntry(
                        value = PreferenceManager.DRAWER_MODE_FOLDERS,
                        label = { stringResource(id = R.string.caddy_beta) },
                    ),
                ),
            )
            ExpandAndShrink(
                visible = drawerModeAdapter.state.value == PreferenceManager.DRAWER_MODE_ALPHABETICAL,
            ) {
